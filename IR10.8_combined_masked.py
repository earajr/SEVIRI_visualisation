...
BT_combined = [BT_grad, BT, BT_diff, BT_thresh]
print(np.shape(BT_combined))
...
plt.savefig(diri+"/images/IR108_combined_masked_"+date+"_"+time+".png",  transparent=True, bbox_inches="tight", pad_inches=0)
